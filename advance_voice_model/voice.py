...
import sys
sys.path.append('OpenVoice')  # Add OpenVoice directory to path if needed
...
def transcribe_with_whisper(audio_file_path):
    # Load the model
    model = whisper.load_model("base.en")   # You can change the model size
...
def user_chatbot_conversation():
    ...
    system_message = "Talk a bit , be very cold"#open_file("chatbot1.txt")
    ...
    while True:
        ...
        style = "default"
        audio_file_pth2 = "C:/Users/kris/_Python/OpenVoice/111.mp3"
